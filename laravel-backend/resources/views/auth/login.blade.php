...
<body>
    ...
    <div class="auth-container">
        ...
        <div class="logo-section">
            ...
            <div class="tagline">Military-Grade Security Portal</div>
        </div>
        
        <h1 class="form-title">System Access</h1>
        ...
        <form method="POST" action="{{ route('login.store') }}" id="loginForm">
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="agent@devguardian.ai">
            </div>
            ...
            <div class="form-options">
                <div class="remember-me">
                    ...
                    <label for="remember">Maintain Session</label>
                </div>
                <a href="#" class="forgot-password">Lost Security Key?</a>
            </div>
            
            <button type="submit" class="btn" id="submitBtn">
                <span class="loading" id="loading"></span>
                <span id="btnText">Initialize Access</span>
            </button>
        </form>
        
        <div class="register-link">
            New operative? <a href="{{ route('register') }}">Request Credentials</a>
        </div>
    </div>
